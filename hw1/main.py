# Generative AI disclosure: I used ChatGPT to explain the purpose of the
# experiment configurations and guide which functions to run for the
# PyTorch demonstrations, single-run experiment, and embedding comparison.
# I reviewed the configuration and ran all experiments locally.
